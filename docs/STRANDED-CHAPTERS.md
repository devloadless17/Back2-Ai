...
Chapters holding questions but fewer than 5 passages: retrieval cannot reach
...
26 questions across 11 chapter(s)

override: `scripts/corpus/toc-overrides/tarbiya__164689a6.md`
...
LS   تربية وطنية          الخلقية الإعلامية                                       4 passages    2 questions
```

## arabic-lit-gsls-se__58bea168

20 questions across 9 chapter(s)

override: `scripts/corpus/toc-overrides/arabic-lit-gsls-se__58bea168.md`

```
SE   أدب عربي             يوحنا قمير: هل في الكواكب إنسان؟                        0 passages    6 questions
GS   أدب عربي             أسعد السكاف: تعريف المقالة                              3 passages    4 questions
...
16 questions across 3 chapter(s)

override: `scripts/corpus/toc-overrides/arabic-lit-lh__3c72187a.md`

```
LH   أدب عربي             من وردتَين اثنتين الشمس: سعيد عقل                       4 passages   13 questions
LH   أدب عربي             غير مُجد: أبو العلاء المعرّي                            1 passages    2 questions
LH   أدب عربي             اللغة ونشاط الجماعة السياسي: أحمد حمّاد                 4 passages    1 questions
```
...
6 questions across 1 chapter(s)

override: `scripts/corpus/toc-overrides/arabic-grammar-lh__27a53b20.md`
...
12 questions across 9 chapter(s), on subjects with no
track. These come from `prisma/seed-data.ts`, not from any book, so no override
will fix them; `npm run db:prune` removes them.

```
     Physique             Circuit RC                                              0 passages    2 questions
     Mathématiques        Fonction exponentielle                                  0 passages    2 questions
     Mathématiques        Suites numériques                                       0 passages    2 questions
     Économie             Inflation et chômage                                    0 passages    1 questions
     Physique             Lois de Newton                                          0 passages    1 questions
     Mathématiques        Nombres complexes                                       0 passages    1 questions
     Sciences de la Vie   Réponse immunitaire adaptative                          0 passages    1 questions
     Chimie               Titrage acido-basique                                   0 passages    1 questions
