...
export function systemPrompt(
  ...
  const common = [
     ...
     * arguing with the first one. What is relaxed is the ban on programme
     * knowledge — the laws and derivations in the textbook, which were always
     * safe. What is KEPT, and stated more sharply than before, is the ban on
    ...
    ...(suppliedProblem
      ? [
          '- The student has handed you a complete problem with its own data. Solve it, step by step, all',
          '  the way through.',
          '- The programme is yours to use: the definitions, laws, derivations and algebra taught in the',
          '  Lebanese programme for this subject. The material below does not have to contain this exact',
          '  problem for you to be allowed to solve it.',
