...
export const ar: Dictionary = {
  ...
  standing: {
    ...
    coverage: 'ما قطعته من المنهج',
    coverageHint: '{practised} من {available} فصلًا تدربت عليها',
    coverageNote: 'الفصول التي تدربت عليها، من فصول منهجك.',
    ...
    mastery: 'المستوى',
    masteryHint: 'في الفصول التي تدربت عليها',
  ...
  summaries: {
    subtitle: 'كتاب لكل مادة. افتح الكتاب لتقرأ فصلاً كما هو في كتابك المدرسي.',
    empty: 'لا مواد فيها محتوى بعد',
    emptyHint: 'هذا محتوى كتابك المدرسي، ويظهر هنا بعد تحميله.',
    ...
    readSummary: 'افتح الفصل',
    writtenFrom: '{count} مقطعاً من كتابك',
    content: 'محتوى الفصل',
  },
  oldCycles: {
  ...
  examSim: {
    ...
    durationStandard: 'مدّتنا المعتمدة — مدّة هذه المسابقة نفسها غير مسجّلة',
    durationHours: '{hours} ساعة',
    durationHoursMinutes: '{hours} ساعة و{minutes} دقيقة',
    durationMinutesOnly: '{minutes} دقيقة',
    sitThisPaper: 'اجلس لهذه المسابقة في ظروف امتحانية',
    duration: 'المدة',
    begin: 'ابدأ',
    ...
    gradedOf: 'صُحّحت {graded} من {total} أسئلة',
    awaitingHuman: '{count} بانتظار مصحّح بشري',
    outOf20Hint: 'محسوبة على 20',
    navAnswered: 'تمت الإجابة',
    navUnanswered: 'بلا إجابة',
    navChip: 'السؤال {number}، {state}',
    navChipMarks: 'السؤال {number}، {marks} علامات، {state}',
  ...
  chat: {
    ...
    searching: 'يبحث في موادّك…',
    solving: 'يشتغل على الحل…',
    solvingFrom: 'يشتغل على الحل انطلاقًا من {source}…',
  ...
  upload: {
    ...
    attach: 'صورة',
    checkTranscription: 'أُرفقت الصورة',
    showTranscription: 'اعرض ما قرأناه',
  ...
  performance: {
    ...
    schoolNoneHint: 'أضف علاماتك المدرسية وسنقارنها بجاهزيتك هنا.',
    schoolLowerAdvice:
  ...
  schedule: {
    ...
    minutes: '{count} دقيقة',
    start: 'ابدأ',
    answersMarked: '{count} إجابات مصححة',
    noAnswersRecorded: 'لا إجابات مسجّلة',
    backlog: 'مدوّن، غير مجدول',
    backlogNote: 'ما دوّنته. امنحه تاريخًا لينضم إلى خطتك.',
    giveDate: 'امنحه تاريخًا',
    ...
    nothingToPlanSoon:
      'هذا الامتحان قريب جداً: الخطة تغطّي الأيام من الغد حتى اليوم الذي يسبقه. اختر امتحاناً أبعد، أو أضف جلسة يدوياً.',
    nothingToPlanSyllabus:
      'لا يتوفّر منهج لهذه المادة بعد، فلا شيء نبني عليه الخطة. أضف جلسة يدوياً في هذه الأثناء.',
  ...
  admin: {
    ...
    chaptersCancelledCount: 'تمّ إلغاء {cancelled} من أصل {total} فصلاً.',
    chapterQuestions: '{count} أسئلة',
    chapterAttempts: '{count} محاولة',
    chapterCancelled: 'ملغى',
    chapterCancel: 'إلغاء الفصل',
    chapterRestore: 'إعادة',
    chapterReasonPlaceholder: 'السبب؟ (اختياري)',
    ...
    targetTracks: 'الفروع المستهدفة',
    targetTracksAllHint: 'بدون تحديد: يصل الإعلان إلى كل الطلاب.',
    targetTracksSomeHint: 'يصل إلى طلاب {tracks} فقط.',
    targetConflict:
      'المادة المختارة تنتمي إلى فرع غير محدّد أعلاه، لذلك لن يصل الإعلان إلى أحد.',
