...
export const en = {
  ...
  summaries: {
    subtitle: 'One book per subject. Open a book to read a chapter straight from your own textbook.',
    empty: 'No subjects with material yet',
    emptyHint: 'This is your textbook content. Once material is loaded it appears here.',
    ...
    readSummary: 'Open the chapter',
    writtenFrom: '{count} passages from your textbook',
  ...
  chat: {
    ...
    send: 'Send',
    thinking: 'Thinking…',
    searching: 'Looking through your material…',
    solving: 'Working it out…',
    solvingFrom: 'Working it out from {source}…',
  ...
  upload: {
    ...
    attach: 'Photo',
    checkTranscription: 'Photo attached',
    showTranscription: 'Show what we read',
