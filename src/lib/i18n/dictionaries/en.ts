...
export const en = {
  ...
  admin: {
    ...
    chaptersCancelledCount: '{cancelled} of {total} chapters cancelled.',
    chapterQuestions: '{count} questions',
    chapterAttempts: '{count} attempts',
    chapterCancelled: 'Cancelled',
    chapterCancel: 'Cancel chapter',
    chapterRestore: 'Restore',
    chapterReasonPlaceholder: 'Why? (optional)',
    ...
    targetTracksAllHint: 'Nothing selected — this reaches every student.',
    targetTracksSomeHint: 'Reaches {tracks} students only.',
    targetConflict:
      'The chosen subject belongs to a track you have not selected, so this announcement would reach nobody.',
