...
export const en = {
  ...
  standing: {
    ...
    madeOf: 'What the mark is made of',
    madeOfNote: 'Two different questions: how well you are doing, and how much of the programme you have covered.',
    strength: 'Strength',
    strengthHint: 'On the chapters you have practised',
    practised: 'Practised',
    practisedOf: '{done} of {total} chapters',
    notStarted: 'Not started',
    needMore: '{count} more answers needed',
    readingNone: 'Nothing practised here yet.',
    readingEarly: 'Early days. The marks will say more with more work behind them.',
    readingStrongNarrow: 'Strong on what you have practised — {done} of {total} chapters. What is missing is breadth, not ability.',
    readingWeakBroad: 'You have been across most of the programme. The marks on it are what need work now.',
    readingStrongBroad: 'Strong across most of the programme.',
